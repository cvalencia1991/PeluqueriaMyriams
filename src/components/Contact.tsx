...
export default function Contact() {
  ...
  return (
    <footer id="contact" className="text-black grid grid-cols-1 grid-rows-2  h-fit w-screen relative place-items-center order-1 lg:grid-rows-2 lg:grid-cols-2 dark:text-white">
